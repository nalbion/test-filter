...
var TestFilter = function (config) {
    ...
    ///**
    // * @param {} config - passed on to JasmineSpecFilter
    // * @returns {JasmineSpecFilter.jasmineSpecFilter}
    // */
    //this.createJasmineSpecFilter = function(config) {
    //    var JasmineSpecFilter = require('./tools/jasmine/jasmine-spec-filter');
    //    var jasmineSpecFilter = new JasmineSpecFilter(config);
